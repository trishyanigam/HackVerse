    ...
    <div className={clsx('w-full flex flex-col gap-1.5', className)}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          required={required}
          className={clsx(
            'w-full bg-dark-bg/60 border rounded-lg text-sm transition-all focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed text-white placeholder-slate-500',
            // Icons padding
            leftIcon ? 'pl-10' : 'pl-4',
