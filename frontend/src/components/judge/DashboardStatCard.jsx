...
import { FiLayers, FiClock, FiCheckSquare, FiAward } from 'react-icons/fi';
...
const colors = {
  assigned: 'from-purple-500 to-indigo-500',
  pending: 'from-amber-500 to-orange-500',
  completed: 'from-emerald-500 to-teal-500',
  avgScore: 'from-blue-500 to-cyan-500',
};

const DashboardStatCard = ({ stat, index }) => {
  const Icon = iconMap[stat.type] || FiLayers;
  const gradient = colors[stat.type] || colors.assigned;
